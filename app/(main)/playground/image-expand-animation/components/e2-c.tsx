...
export function Experiment2C() {
  ...
  return (
    <>
      <h3 className="font-bold mt-16">§ E2-C: Summary of AnimatePresence</h3>
      <div className="mt-8 space-y-4 text-muted-foreground">
        ...
        <ol>
          ...
          <li><span className="text-pink-600 font-medium">Link</span>: Use <code>LayoutId</code> tell framer-motion to link the initial/end layout and selected layout</li>
      ...
      <div className="mt-8 flex flex-col items-center p-10">
        ...
        <div className="relative">
          <div className="absolute top-[50%] left-0 translate-x-[-150%] translate-y-[-50%] text-blue-600">Grid</div>
        ...
        <div className="relative">
          ...
          <div className="relative flex p-2 size-48 border-2 border-dashed border-teal-600 rounded-3xl justify-center items-center">
            ...
            <div className="size-40 rounded-full border-2 border-dashed border-teal-600 flex items-center justify-center">
              <span className="text-teal-600 font-medium">4-n</span>
            </div>
        ...
        <div className="absolute top-[50%] left-0 translate-x-[-110%] translate-y-[-50%] text-teal-600">AnimatePresence</div>
        </div>
      </div>
    </>
  );
