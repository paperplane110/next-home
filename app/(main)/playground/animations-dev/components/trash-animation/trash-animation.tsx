      ...
      <div className="relative flex h-[500px] flex-col items-center justify-center">
        ...
        <AnimatePresence>
          {imagesToRemove.length > 0 && !readyToRemove ? (
            <motion.div
              key="toolbar"
              className="absolute bottom-8 flex gap-1 rounded-xl p-1 shadow-md will-change-transform"
            ...
            >
              <div className="flex w-full justify-between gap-1">
                <button 
                  className="flex w-12 flex-col items-center gap-px rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 text-[10px] font-medium text-[#8D8D86] hover:bg-[#FFF7F7] hover:text-[#df7d32]"
                  onClick={() => {
                    setImagesToRemove([])
                  }}
                >
                ...
                <button
                  ...
                  className="flex w-12 flex-col items-center gap-px rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 text-[10px] font-medium text-[#8D8D86] hover:bg-[#FFF7F7] hover:text-[#E5484D]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                ...
                <button className="flex w-12 flex-col items-center gap-px rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 text-[10px] font-medium text-[#8D8D86]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
        ...
        <AnimatePresence>
          {readyToRemove ? (
            <div className="absolute top-1/2 z-10 h-[114px] w-24 -translate-y-1/2">
              ...
              {/* 通过控制 parent 来实现：进入时的抛物线，退出时进入垃圾桶的动画 */}
              <motion.div
              ...
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0, transition: { delay: 0, duration: 0 } }} // When images are deleted, this will let the svg disappear immediately.
                transition={{ duration: 0, delay: 0.175 }}
              >
                <TrashFront />
              </motion.div>
            </div>
