                        ...
                        return (
                          <Badge
                            ...
                            <div
                              ...
                              className="ml-1 h-4 w-4 flex items-center justify-center cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
                              <XCircle
                                className={cn(
                                  "size-4",
                                  responsiveSettings.compactMode &&
                      ...
                      {group.options.map((option) => {
                        ...
                        return (
                          <CommandItem
                            ...
                            {option.icon && (
                              <option.icon
                                className="mr-2 size-3 text-accent"
                                aria-hidden="true"
                              />
                            )}
